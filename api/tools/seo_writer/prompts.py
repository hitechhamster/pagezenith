...
14. **结尾必须落地。** 最后一段不许写"策略比工具更重要""专注长期价值""保持专业"
...
DATE_LINE = """今天是 {today}（{year} 年）。文中的"今年 / 现在 / 最新 / 当前 / this year / current /
latest"一律指 {year} 年。标题、小标题里若出现年份，必须是 {year}，不许把往年年份当作"最新"。
引用往年的数据可以，但要写明那是哪一年的数据。
